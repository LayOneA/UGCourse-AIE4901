...
The public dataset we selected is sourced from the official competition dataset of the TiPDM Cup. To access the dataset (path: Test/datasets/tipdm/raw), you can download via these link:
